				    ...
				    <div class='card-body'>
							...
							<form method="post" action="ExecuteUpdateFilmServlet" class="row g-3" novalidate="novalidate">
								...
								<div class="col-md-6">
									...
									<input type="text" name="titolo" id="titolo" class="form-control" placeholder="Inserire il titolo" value="${update_film_attr.titolo }" required>
								</div>
								
								<div class="col-md-6">
									<label for="genere" class="form-label">Genere <span class="text-danger">*</span></label>
									<input type="text" name="genere" id="genere" class="form-control" placeholder="Inserire il genere" value="${update_film_attr.genere }" required>
								</div>
